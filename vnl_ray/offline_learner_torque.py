...
def run_simulation(learner, actuator_type, render=False, num_episodes=10, rollout_length=200):
    """
...
def main(config: DictConfig) -> None:
    ...
    all_activations_per_episode, all_kinematics_per_episode = (
        run_simulation(learner, actuator_type, render=True, num_episodes=1, rollout_length=600),
    )
